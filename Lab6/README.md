...
```
    ...
    Скачанные бинарные пакеты находятся в
        C:\Users\zvono\AppData\Local\Temp\Rtmp2thVVM\downloaded_packages
...
Подготовим датафрейм с расшифровкой Windows Event_ID и приведем типы
...
Active Directory, изучена структура журнала системы Windows Active
Directory, закреплены практические навыки использования языка
программирования R для обработки данных, а также закреплены знания
